...
public class CircleImageView extends ImageView {
    ...
    protected boolean mForceFocus = false;
    protected boolean mFocusOnTop = true;
    protected int mFocusPaddingLeft = 0;
    protected int mFocusPaddingRight = 0;
    protected int mFocusPaddingTop = 0;
    protected int mFocusPaddingBottom = 0;
    protected int mDefaultFocusFrame = R.drawable.singer_icon_frame;
    private boolean mEnableAutoShow = false;
...
//        EvLog.d("something", "MaskFocusButton: gainFocus: " + focused + " direction: " + direction);
    ...
    private void drawFocus(Canvas canvas) {
        if((mFocusFlag && !isPressed()) || mForceFocus) {
...
//            drawable.setBounds(0, 0, getWidth(), getHeight());
    ...
    public void setFocusPadding(int left, int right, int top, int bottom) {
        mFocusPaddingLeft = left;
        mFocusPaddingRight = right;
        mFocusPaddingTop = top;
        mFocusPaddingBottom = bottom;
    }
    
    public void setFocusOnTop(boolean top) {
        mFocusOnTop = top;
    }
     ...
     * @param value 值
     */
    public void setEnableAutoShow(boolean value) {
        mEnableAutoShow = value;
        if (mEnableAutoShow) {
