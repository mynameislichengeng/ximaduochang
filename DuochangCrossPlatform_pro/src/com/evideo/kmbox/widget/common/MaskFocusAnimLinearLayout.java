 ...
 * [带动画边框layout]
 */
public class MaskFocusAnimLinearLayout extends MaskFocusLinearLayout implements AnimatorUpdateListener {
     ...
     * @param defStyle
     */
    public MaskFocusAnimLinearLayout(Context context, AttributeSet attrs,
            int defStyle) {
    ...
    public MaskFocusAnimLinearLayout(Context context) {
        super(context);
    }
