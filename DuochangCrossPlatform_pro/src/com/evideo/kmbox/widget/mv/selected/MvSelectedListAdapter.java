 ...
 * [功能说明]
 */
public class MvSelectedListAdapter extends BaseSongListAdapter<KmPlayListItem> {
    ...
    public MvSelectedListAdapter(Context context, ViewGroup parentView,
            ArrayList<KmPlayListItem> datas) {
        super(context, parentView, datas);
        mSpecWidthNormal = context.getResources().
                getDimensionPixelSize(R.dimen.px204);
        mSpecWidthLonger = context.getResources().
                getDimensionPixelSize(R.dimen.px300);
    ...
    protected View newConvertView(int position, ViewGroup parent) {
        View view = View.inflate(mContext, R.layout.mv_selected_list_item, null);
...
//            viewHolder.mPlayingIcon.setVisibility(View.GONE);
        ...
        viewHolder.mSingerName.setCompoundDrawablesWithIntrinsicBounds(R.drawable.km_score_placeholder, 0, 0, 0);
