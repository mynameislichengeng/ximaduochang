...
public class BaseAdapterHelper {
    ...
    public BaseAdapterHelper setFocusable(int viewId, boolean value) {
        View view = retrieveView(viewId);
        view.setFocusable(value);
        return this;
    }
    
    public BaseAdapterHelper clearFocus(int viewId) {
        View view = retrieveView(viewId);
        view.clearFocus();
        return this;
    }
    ...
    public BaseAdapterHelper setTextOnFocusChanged(int viewId, OnFocusChangeListener onFocusChangeListener) {
        TextView view = retrieveView(viewId);
        view.setOnFocusChangeListener(onFocusChangeListener);
        return this;
    }
    
    public BaseAdapterHelper setButtonOnFocusChanged(int viewId, OnFocusChangeListener onFocusChangeListener) {
        Button button = retrieveView(viewId);
        button.setOnFocusChangeListener(onFocusChangeListener);
        return this;
    }
    
    public BaseAdapterHelper setButtonText(int viewId, String value) {
        Button button = retrieveView(viewId);
