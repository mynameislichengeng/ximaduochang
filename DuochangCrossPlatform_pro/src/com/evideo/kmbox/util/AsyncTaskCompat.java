 ...
 *
 * <p>AsyncTaskCompat is designed to be a helper class around {@link Thread} and {@link Handler}
 * and does not constitute a generic threading framework. AsyncTaskCompats should ideally be
 ...
 *
 * <h2>Usage</h2>
 * <p>AsyncTaskCompat must be subclassed to be used. The subclass will override at least
 * one method ({@link #doInBackground}), and most often will override a
 * second one ({@link #onPostExecute}.)</p>
 *
 * <p>Here is an example of subclassing:</p>
 * <pre class="prettyprint">
 * private class DownloadFilesTask extends AsyncTaskCompat&lt;URL, Integer, Long&gt; {
 ...
 * </pre>
 *
 * <h2>AsyncTaskCompat's generic types</h2>
 ...
 * <pre>
 * private class MyTask extends AsyncTaskCompat&lt;Void, Void, Void&gt; { ... }
 * </pre>
 *
 * <h2>The 4 steps</h2>
 ...
 * work properly:</p>
 * <ul>
 *     <li>The AsyncTaskCompat class must be loaded on the UI thread. This is done
 ...
 * <p>AsyncTaskCompat guarantees that all callback calls are synchronized in such a way that the following
 ...
 * <p>When first introduced, AsyncTaskCompats were executed serially on a single background
...
public abstract class AsyncTaskCompat<Params, Progress, Result> {
     ...
     * introduced, AsyncTaskCompats were executed serially on a single background thread.
