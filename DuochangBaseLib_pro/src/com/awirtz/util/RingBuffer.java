...
public class RingBuffer {
    ...
    private static RingBuffer instance = null;
    public static RingBuffer getInstance() {
        if(instance == null) {
            synchronized (RingBuffer.class) {
                RingBuffer temp = instance;
                if(temp == null) {
                  temp = new RingBuffer();
                  instance = temp;
                }
...
//        byteArray = new byte[size];
   ...
   /* public RingBuffer(byte[] buffer) {
    ...
    public int write(byte[] buffer, int offset, int length) {
        if (byteArray == null) {
            EvLog.e("RingBuffer write byteArray is bull");
            return 0;
        }
    ...
    public int writer(RingBufferWriter writer, int length) {
        if (byteArray == null) {
            EvLog.e("RingBuffer writer byteArray is bull");
            return 0;
        }
    ...
    public int read(byte[] buffer, int offset, int length) {
        if (byteArray == null) {
            EvLog.e("RingBuffer read byteArray is bull");
            return 0;
        }
    ...
    public int reader(RingBufferReader reader, int length) {
        if (byteArray == null) {
            EvLog.e("RingBuffer reader byteArray is bull");
            return 0;
        }
